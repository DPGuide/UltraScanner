...
class UltraScanner(QtWidgets.QMainWindow):
    ...
    def init_ui(self):
        ...
        self.autotune_btn.setStyleSheet("background-color: #00CED1; color: black; font-weight: bold; padding: 5px;")
        self.autotune_btn.clicked.connect(self.do_autotune)
        rx_layout.addWidget(self.autotune_btn)
        ...
        self.tol_spinbox.setValue(1000) 
        ...
        self.clear_btn.setStyleSheet("background-color: #FF4444; color: white; font-weight: bold; padding: 10px;")
        self.clear_btn.clicked.connect(self.clear_decoded_text)
